...
from config import TEST_QUESTIONS, ADMIN_NOTIFICATION_CHAT_ID, DIAGNOSTIC_REQUEST_TEXT, REQUEST_PHONE_NUMBER_TEXT, PHONE_RECEIVED_CONFIRMATION, INVALID_PHONE_NUMBER_FORMAT, ADMIN_NEW_CALLBACK_REQUEST
